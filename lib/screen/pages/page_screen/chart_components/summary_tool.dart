    ...
    return Container(
      ...
      child: Padding(
        padding: EdgeInsets.all(
            ResponsiveBreakpoints.of(context).isDesktop ? 0.6.w :ResponsiveBreakpoints.of(context).isTablet? 1.w: 2.w),
        child: Column(
          children: [
            Expanded(
                flex: 5,
                      ...
                      Text("Total tools Sale on this month",
                          style: TextStyle(
                              ...
                              fontSize:
                                  ResponsiveBreakpoints.of(context).isDesktop
                                      ? 2.sp
                                      :ResponsiveBreakpoints.of(context).isTablet? 3.5.sp: 8.sp))
                    ],
                  ),
                )),
            SizedBox(
              height: ResponsiveBreakpoints.of(context).isTablet? 0:0.1.h,
            ),
            Expanded(
                flex: 12,
                child: Row(
